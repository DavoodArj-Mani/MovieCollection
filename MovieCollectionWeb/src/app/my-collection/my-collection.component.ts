...
export class MyCollectionComponent implements OnInit {
  ...
  myCollectionDisplayedColumns: string[] = ['CollectionId', 'CollectionName','action'];
  myCollectionDataSource = new MatTableDataSource<Collection>();

  myMovieDisplayedColumns: string[] = ['CollectionId', 'CollectionName','MovieId', 'MovieName','action'];
  myMovieDataSource = new MatTableDataSource<SelectedCollectionMovie>();

  movieDisplayedColumns: string[] = ['MovieId', 'MovieName','action'];
